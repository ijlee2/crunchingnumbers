...
function vla_eigenvalues(~, ~, callerName)
    ...
    % ---------------------------------------------------------------------
    %----------------------------------------------------------------------
    set(handle_title, 'String', 'Eigenvalues and eigenvectors');
    ...
    title('Click and drag on this plot window!', ...
          'FontUnits', 'normalized', ...
          'FontSize' , 0.055);
    
    xlabel('x_{1}'     , 'FontUnits', 'normalized', ...
                         'FontSize' , 0.075);
    ylabel('x_{2}     ', 'FontUnits', 'normalized', ...
                         'FontSize' , 0.075, ...
                         'Rotation' , 0);
