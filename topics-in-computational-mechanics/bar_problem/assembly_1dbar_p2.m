...
%--------------------------------------------------------------------------
function assembly_1dbar_p2(problem_size)
    % Load the assembly file
    load(strcat('assembly_files/assembly_1dbar_p2_numElements', problem_size));
    ...
    save(strcat('solution_files/solution_1dbar_p2_numElements', problem_size), 'u', 'f', 'gcon', '-v6');
end